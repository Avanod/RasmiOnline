    ...
    public class SmsStrategy : IMessagingStrategy
    {
        ...
        public IActionResponse<bool> Send(Message message)
        {
            ...
            try
            {
                ...
                //   var sendResult = _smsAdapter.SendMessage("mamirshahi", "jobTyw-5paqwi-byjciw", "50002210004039", message.Content, new ArrayOfString() { message.Receiver }, 1, null);
                var sendResult = _smsAdapter.SendMessage("tarjomano1", "11360655", "9830008638000067", message.Content, new ArrayOfString() { message.Receiver }, 1, new ArrayOfLong() { 1 });
