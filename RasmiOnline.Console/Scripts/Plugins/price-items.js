...
var getPriceItems = function (templateId, succesFunc, failedFunc) {
    if (templateId > 0) {
        $.ajax({
            url: 'https://Portal.amirshahigroup.com/PricingItem/GetPricingItemTable?templateId=' + templateId,
            data: JSON.stringify({}),
            type: 'GET',
...
var getPriceItemsWithCategoryId = function (categoryId, succesFunc, failedFunc) {
    if (categoryId > 0) {
        ...
        $.ajax({
            url: 'https://Portal.amirshahigroup.com/PricingItem/GetPricingItemTableWithCategoryId?categoryId=' + categoryId,
            data: JSON.stringify({}),
            type: 'GET',
            contentType: 'text/html'
        })
...
var getPricingItemAccordion = function (succesFunc, failedFunc) {
    $.ajax({
        url: 'https://Portal.amirshahigroup.com/PricingItem/GetPricingItemAccordion',
        data: JSON.stringify({}),
        type: 'GET',
        contentType: 'text/html'
    })
...
//    $.ajax({
//        url: 'https://Portal.amirshahigroup.com/Channel/Visit',
