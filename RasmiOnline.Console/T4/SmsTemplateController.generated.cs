...
namespace RasmiOnline.Console.Controllers
{
    public partial class SmsTemplateController
    {
        ...
        protected SmsTemplateController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public SmsTemplateController Actions { get { return MVC.SmsTemplate; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "SmsTemplate";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "SmsTemplate";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Search = "~/Views/SmsTemplate/Search.cshtml";
            ...
            public partial class _PartialsClass
            {
                ...
                public readonly string _Form = "~/Views/SmsTemplate/Partials/_Form.cshtml";
                public readonly string _SearchList = "~/Views/SmsTemplate/Partials/_SearchList.cshtml";
                public readonly string _SearchView = "~/Views/SmsTemplate/Partials/_SearchView.cshtml";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SmsTemplateController : RasmiOnline.Console.Controllers.SmsTemplateController
    {
        public T4MVC_SmsTemplateController() : base(Dummy.Instance) { }

        [NonAction]
        partial void SearchOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, RasmiOnline.Domain.Dto.SmsTemplateSearchFilter model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Search(RasmiOnline.Domain.Dto.SmsTemplateSearchFilter model)
        {
        ...
        [NonAction]
        partial void FormSubmitedOverride(T4MVC_System_Web_Mvc_JsonResult callInfo, RasmiOnline.Domain.Entity.SmsTemplate model);

        [NonAction]
        public override System.Web.Mvc.JsonResult FormSubmited(RasmiOnline.Domain.Entity.SmsTemplate model)
        {
